...
const Form = ({ currentId, setCurrentId }) => {
  const [postData, setPostData] = useState({ type: '', title: '', message: '', price: '', tags: [], selectedFile: '' });
  ...
  const clear = () => {
    setCurrentId(0);
    setPostData({ type: '', title: '', message: '', price: '', tags: [], selectedFile: '' });
  };
    ...
    return (
      <Paper className={classes.paper} elevation={6}>
        <Typography variant="h6" align="center">
          Please Sign In to create your posts and review other's posts.
        </Typography>
      </Paper>
    );
  }
  ...
  return (
    <Paper className={classes.paper} elevation={6}>
      <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
        ...
        <TextField name="type" variant="outlined" label="Type" placeholder='Sale, Rental,'fullWidth value={postData.type} onChange={(e) => setPostData({ ...postData, type: e.target.value })} />
        ...
        <div style={{ padding: '5px 0', width: '94%' }}>
          <ChipInput
            ...
            variant="outlined"
            label="Tags"
            placeholder='Type, Brand, Model, Year, Color'
            fullWidth
            value={postData.tags}
